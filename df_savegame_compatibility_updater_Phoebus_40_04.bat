@ECHO Off
ECHO ---------------------------------------------------------------------
ECHO - Welcome to the Dwarf Fortress Compatibility Savegame RAW Updater. -
ECHO - For worlds created with Dwarf Fortress 0.40.04 or earlier.        -
ECHO ---------------------------------------------------------------------
ECHO .
...
ECHO Adjusting RAWs for compatibility with Phoebus_40_04 worlds: %~1
XCOPY "raw_compatibility\Phoebus_40_04" "%~1\raw" /c /v /q /i /s /e /y
GOTO :eof
